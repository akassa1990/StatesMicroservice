...
public class SwaggerConfig {
  ...
  private static final Contact CONTACT =
      new Contact("Ahmed Kassa", "http://www.ahmedkassa.com", "ahmed.kassa1990@gmail.com");
  ...
  private ApiInfo metaInfo() {
    ...
    return new ApiInfo(TITLE, DESCRIPTION, SWAGGER_API_VERSION, "Terms of Service", CONTACT,
        LICENCE_TEXT, "http://www.apache.org/licenses/");
  }
}
